"""CarbonSight CLI entrypoint. Commands: advise, train, run, mappings validate, backtest run."""

import typer

from carbonsight_cli.commands import advise, backtest, mappings, run, train
